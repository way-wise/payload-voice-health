...
import CompanyOne from "../../../../public/testimonial/company_1.png";
import CompanyTwo from "../../../../public/testimonial/company_2.png";
import UserOne from "../../../../public/testimonial/user_1.png";
import UserTwo from "../../../../public/testimonial/user_2.png";

const TesimonialsData = [
  {
    name: "Linda M",
    title: "Office Manager, Greenfield Family Clinic",
    testimonial:
      "We've seen a noticeable drop in missed appointments and phone traffic since integrating the virtual assistant. It handles repetitive tasks with ease, freeing up our staff to focus on in-person patient care. Truly a game-changer.",
    image: UserOne.src,
    company: CompanyOne.src,
  },
  {
    name: "Rajiv P.",
    title: "Office Administrator, Sunrise Women’s Health",
    testimonial:
      "VoiceHealth's AI receptionist has completely transformed our front desk operations. Patients now  get quick responses for scheduling and follow-ups—even after hours. It's like having a tireless team  member who never misses a beat.",
    image: UserTwo.src,
    company: CompanyTwo.src,
  },
];
    ...
    <section className="md:pt-4 pt-2 pb-20 md:pb-[96px]" id="testimonials">
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-10">
          {TesimonialsData.map((item, index) => (
            <div
              key={index}
