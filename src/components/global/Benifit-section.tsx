...
const cards = [
  ...
  },
  {
    ...
    points: ['Reduce staff burnout', 'Book more appointments', 'Do seamless onboarding'],
    image: ImageTwo.src,
  },
  {
    title: 'Patients',
    points: ['No more waiting time', 'Call 24/7', 'Experience white glove service every time'],
